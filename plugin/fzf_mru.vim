...
command! -nargs=* FZFMruPreview call s:fzf_mru_preview(<q-args>)
command! -nargs=* FZFFreshMruPreview call fzf_mru#mrufiles#refresh() <bar> call s:fzf_mru_preview(<q-args>)
